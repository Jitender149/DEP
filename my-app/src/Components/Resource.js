...
//         </DialogActions>
//       </Dialog>
//       <Dialog open={uploadingPicture} onClose={() => setUploadingPicture(false)}>
//         <DialogTitle>Upload Profile Picture</DialogTitle>
//         <form onSubmit={handleImageUpload}>
//           <DialogContent>
//             <Box sx={{ mb: 2 }}>
//               <input accept="image/*" type="file" name="file" required />
//             </Box>
//           </DialogContent>
//           <DialogActions>
//             <Button onClick={() => setUploadingPicture(false)}>Cancel</Button>
//             <Button type="submit" variant="contained" color="primary" disabled={uploadingPicture}>
//               {uploadingPicture ? <CircularProgress size={24} /> : "Upload"}
//             </Button>
//           </DialogActions>
//         </form>
//       </Dialog>
